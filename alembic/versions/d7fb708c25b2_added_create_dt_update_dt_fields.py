...
def upgrade():
    ...
    op.add_column('product_lists', sa.Column('create_dt', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True))
    op.add_column('product_lists', sa.Column('update_dt', postgresql.TIMESTAMP(timezone=True), nullable=True))
    op.drop_index('ix_product_lists_id', table_name='product_lists')
    op.add_column('search_texts', sa.Column('create_dt', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True))
    op.add_column('search_texts', sa.Column('update_dt', postgresql.TIMESTAMP(timezone=True), nullable=True))
